        ...
        <div className="border rounded-lg">
          <div className="max-h-64 overflow-y-auto p-4 text-sm scrollbar-thin space-y-4">
            ...
            <p>
              ...
              is a <strong>non-custodial</strong> wallet, meaning the Charity
              alone controls its private keys and is responsible for managing
              and securing its funds.
            </p>

            {/* DEFINITIONS */}
            <h2 className="font-semibold mt-4">2. DEFINITIONS</h2>
            <p>
              2.1. <strong>Tax Receipt</strong>: An official receipt generated
              by digidov containing all information required under United States
              and Canadian regulatory standards for charitable donations. These
              receipts are sent to Donors via email and made available for
              download in the Donor’s online dashboard.
            </p>
            <p>
              2.2. <strong>Crypto Donation</strong>: A transfer of
              cryptocurrency that flows from the Donor’s wallet into a proxy or
              smart contract wallet controlled by digidov{" "}
            ...
            <ul className="list-disc list-inside mt-1">
              <li>
                (a) Enable the Charity to accept cryptocurrency donations
                through digidov’s platform;
              </li>
              <li>
                (b){" "}
                <em>
              ...
              <li>
                (c) Generate and deliver official donation tax receipts to
                donors on behalf of the Charity;
              </li>
              <li>
              ...
              <li>
                (f) Record and manage donation transactions, including
                generating unique transaction identifiers and corresponding Tax
                Receipt identifiers;
              </li>
              <li>
                (g) Issue official Tax Receipts, sent via email and available
                for donor download; and
              </li>
              <li>
                (h) Provide online dashboards allowing (i) the Charity to view
                transactions and Tax Receipts for all its donors, and (ii) each
                donor to view only that donor’s own transactions and Tax
                Receipts.
              </li>
            </ul>
            <p className="mt-2">
              3.2. digidov does <strong>not</strong> assume custody of any
              donated cryptocurrency. All Charity wallets used on digidov’s
              platform remain non-custodial, with the Charity fully responsible
              for managing and protecting its private keys, funds, and all
              associated wallet security measures.
            </p>
            ...
            <p>
              4.3. <strong>Network / Gas Fees</strong>: The Charity is
              responsible for any blockchain network fees or gas fees incurred
              during transfers or withdrawals.
            </p>
            ...
            <p>
              5.1. All donations initially route through a proxy or smart
              contract wallet controlled by digidov <strong>solely</strong> to
              forward donated funds to the Charity’s non-custodial wallet. The
              Charity remains custodial of its funds at all times once they
              arrive in its designated wallet. The Charity must take all
              necessary measures to protect its wallet from threats, attacks,
              and unauthorized access, and is solely responsible for any
              security breaches that occur.
            </p>
            <p>
              <em>(Paragraphs 5.2 and 5.3 have been removed.)</em>
            </p>
            ...
            <p>
              6.2. The Charity must inform digidov of any changes to its status
              as a registered charity or any material changes to donation
              eligibility rules.
            </p>
            ...
            <p>
              <em>(Paragraph 7.4 has been removed.)</em>
            </p>
            ...
            <p>
              <em>
                (Remainder of the original 8.1 text regarding “no sale of donor
                data” has been removed at your request.)
              </em>
            </p>
            <p>
            ...
            <p>
              ...
              <strong>To the fullest extent permitted by law</strong>, digidov
              is not liable for crypto market fluctuations or tax-related
            ...
            <p>
              9.3. <strong>Indemnification</strong>: The Charity shall
              indemnify, defend, and hold harmless digidov, its affiliates,
              officers, directors, employees, and agents from any and all
              claims, losses, or damages arising out of or related to the
              Charity’s failure to secure or manage its cryptocurrency funds or
            ...
            <p>
              ...
              prior or contemporaneous communications, understandings, or
            ...
            <p>
              12.1. The Charity hereby grants digidov a standing authorization
              to digitally sign all Tax Receipts issued on the Charity’s behalf.
            ...
            <p className="mt-2">
              13.2. The information available on the dashboard shall serve as
              the official record for all processed transactions and fee
              deductions for the Charity’s accounting, auditing, and regulatory
              compliance purposes.
            </p>
            ...
            <p>
              ...
              corporate reorganization, or sale of all or substantially all of
              its assets. This Agreement shall be binding on and inure to the
            ...
            <p>
              16.1. <strong>digidov’s IP</strong>: All right, title, and
              interest in and to the digidov platform, software, trademarks,
              trade names, and any related or underlying technology (including
              any modifications or derivatives) are and shall remain the
              exclusive property of digidov.
            </p>
            <p>
              16.2. <strong>Charity’s IP</strong>: The Charity retains all
              right, title, and interest in and to its own trademarks, logos,
              proprietary content, and other intellectual property. No rights or
              licenses are granted to digidov under this Agreement except as
              needed to perform the services described herein.
            </p>
            ...
            <p>
              ...
              NON-INFRINGEMENT. DIGIDOV DOES NOT WARRANT THAT THE SERVICES WILL
            ...
            <p>
              ...
              the performance of its obligations under this Agreement if such
              failure or delay is caused by events beyond the Party’s reasonable
              control, including but not limited to acts of God, war, terrorism,
              riots, embargoes, acts of civil or military authorities, fires,
              floods, accidents, strikes, or shortages of transportation
              facilities, fuel, energy, labor, or materials. The affected Party
              shall promptly notify the other Party of the occurrence of a force
              majeure event and shall use commercially reasonable efforts to
              mitigate its effects and resume performance as soon as
              practicable.
            </p>
            ...
            <p>
              ...
              Party’s name, trademarks, or logos in any marketing, press
              releases, promotional materials, or public announcements without
              the prior written consent of the other Party, which may be
            ...
            <p>
              20.1. Nothing in this Agreement shall be construed to create a
              joint venture, partnership, agency, or fiduciary relationship
              between the Parties. Both Parties are independent contractors, and
            ...
            <p>
              ...
              rights, benefits, remedies, or claims upon any person or entity
            ...
            <p>
              22.1. Any notice or other communication required or permitted to
              ...
              deemed effective upon the sending Party’s receipt of a
              confirmation (via read receipt or a written acknowledgment from
              the recipient) indicating that the recipient received and reviewed
              the email. Each Party shall promptly notify the other Party of any
              changes to its designated email address for notices under this
              Agreement.
            </p>
            ...
            <p>
              ...
              use digidov’s platform in violation of any such laws or
            ...
            <p>
              ...
              deemed valid and enforceable. For the purposes of this Agreement,
              an electronic signature may include the act of typing one’s first
              and last name into a form. The Parties further agree that this
              Agreement and any subsequent amendments or modifications may be
              entered into electronically, and that any such electronic
